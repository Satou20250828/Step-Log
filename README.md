...
StepLog では、機能を増やすことよりも、行動の心理的ハードルを下げることを重視しています。

- 習慣を1つだけ登録できる機能  
  習慣数を制限することで、何から始めるか迷わず行動できるようにしています。

- 1日1回、3択で行動を記録できる機能  
  入力内容を最小限にし、記録そのものが負担にならない設計としています。

- 行動履歴を一覧で確認できる機能  
  継続の有無ではなく、「行動した事実」を振り返れるようにしています。

- 記録した累計日数の表示  
  連続日数やカレンダー表示は行わず、積み重ねた回数のみを可視化します。

- 行動を肯定するメッセージ表示  
  行動できたこと自体を評価し、自己否定につながらない体験を目指しています。

- ログイン不要で利用できる仕組み  
  初回アクセスからすぐに使える体験を優先し、利用開始のハードルを下げています。
